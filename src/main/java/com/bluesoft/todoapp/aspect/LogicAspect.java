package com.bluesoft.todoapp.aspect;
...
class LogicAspect {
    ...
    @Pointcut("execution(* com.bluesoft.todoapp.logic.ProjectService.createGroup(..))")
    ...
    void logMethodCall(JoinPoint jp){
        logger.info("Befor {} with {}", jp.getSignature().getName(), jp.getArgs());
    }
